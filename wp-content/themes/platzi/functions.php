...
function assets(){
    ...
    wp_register_style('montserrt','https://fonts.googleapis.com/css2?family=Montserrat&display=swap','','1.0','all');

    wp_enqueue_style('estilos',get_stylesheet_uri(),array('bootstrap','montserrt'),'1.0','all');
